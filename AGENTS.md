...
- **Name**: ecom-arb (E-commerce Arbitrage)
- **Language**: TBD (greenfield project - define in North Star)
- **Status**: Greenfield - no existing code
- **Key Paths**: TBD - will be defined during initial planning

### Project State

This is a **new project** with no existing codebase. Before writing any code:

1. Complete `PLAN/00_north_star.md` - Define what success looks like
2. Complete `PLAN/01_requirements.md` - Capture detailed requirements
3. Run `/decompose` to create initial beads from requirements
